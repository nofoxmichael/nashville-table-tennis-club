                ...
                <section id="two" className="main style2">
                    <div className="grid-wrapper">
                        <div className="col-6">
                            ...
                            <Location url="https://goo.gl/maps/V6uRMi4NWeK2" address="17250 Nolensville Rd, Nolensville, TN 37135" time="Friday: 5:30 PM - 8:30 PM" venue="Nolensville Rec Center"></Location>
                            <Location url="https://goo.gl/maps/V6uRMi4NWeK2" address="920 Heritage Way, Brentwood, TN 37027" time="Sunday: 3:00 PM - 6:00 PM" venue="Indoor Sports Complex"></Location>
                        </div>
                        <div className="col-6">
                            <header className="major">
